...
/* limite du monde */
#define LIMITE_MIN_X -100
#define LIMITE_MIN_Y -100
#define LIMITE_MIN_Z -100
#define LIMITE_MAX_X 100
#define LIMITE_MAX_Y 100
#define LIMITE_MAX_Z 200
...
/* Mode de jeu */
#define MODE_JEU 0  // si != 0, alors on lance en mode jeu
